...
link ".pentest-aliases"
link ".zprofile"
link ".zsh-aliases"
link "zsh-wakatime.plugin.zsh"
link ".zshenv"
link ".zshrc"
link ".curlrc"
...
link ".config/git/common" ".config/git/config"
...
link ".config/systemd/user/wlunset.service"
...
if is_chroot; then
    ...
    systemctl_enable_start "wlunset.service"
